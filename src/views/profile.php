            ...
            <div class="profile-form__container">
                ...
                <form method="POST" action="?action=update_profile" enctype="multipart/form-data">
                    ...
                    <div class="profile-form__button-wrapper">
                        <a href="?action=change_password"
                            class="profile-form__button profile-form__button--secondary">Đổi mật khẩu</a>
                        <button type="submit" name="save_profile"
                            class="profile-form__button profile-form__button--primary">Lưu thay đổi</button>
                    </div>
                </form>
            </div>
        </div>
